...
DEVICE_PATH := device/tecno/TECNO-KG5p
...
# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := TECNO-KG5p
...
TARGET_KERNEL_CONFIG := TECNO-KG5p_defconfig
TARGET_KERNEL_SOURCE := kernel/tecno/TECNO-KG5p
